...
router.post('/watchlist/add', _protectRoute["default"], _usercontroller.addToWatchlist); // Ensure protectRoute is applied.
...
router.get('/following/:username', _usercontroller.getUserFollowing); //signin
